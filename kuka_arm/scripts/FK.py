...
def forward_kinematics(theta1, theta2, theta3, theta4, theta5, theta6):
    ...
    T_wc = T0_5.evalf(subs={q1: theta1, q2: theta2, q3: theta3, q4: theta4, q5: theta5})

    T_ee = T_total.evalf(subs={q1: theta1, q2: theta2, q3: theta3, q4: theta4,
                                 q5: theta5, q6: theta6, q7: 0})

    wc = Matrix([[T_wc[0,3]], [T_wc[1,3]], [T_wc[2,3]]])    
    ee = Matrix([[T_ee[0,3]], [T_ee[1,3]], [T_ee[2,3]]])
